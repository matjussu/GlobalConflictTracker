#!/usr/bin/env python3
"""
Seed Firestore with sample data for Global Conflict & Intelligence Tracker.
...
Usage:
    ...
    2. Run:
       ...
       python seed_firestore.py --key path/to/serviceAccountKey.json
"""
    ...
    return [
        {
            ...
            "emblemURL": "",
            "type": "nation",
            "personnelCount": 480000,
            "fleetStrength": 340000,
            "airAssets": 320000,
        ...
        },
        {
            ...
            "emblemURL": "",
            "type": "nation",
            "personnelCount": 247000,
            "fleetStrength": 114000,
            "airAssets": 47000,
    ...
    return [
        {
            ...
            "body": "Satellite reconnaissance confirms mobilization of heavy armor divisions along the southern demilitarized zone.",
            "timestamp": now - timedelta(hours=2),
            "sector": "Sector 7",
            "severity": "critical",
            "imageURL": None,
        ...
        },
        {
            ...
            "body": "Signal intelligence intercepted a series of encrypted communications from a naval task force operating in restricted waters.",
        ...
        },
        {
            ...
            "body": "Commercial satellite imagery reveals significant troop buildup along the northern border region.",
        ...
        },
        {
            ...
            "body": "A classified diplomatic cable has surfaced indicating imminent sanctions against three nations.",
